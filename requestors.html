...
function ToPending(requestor_id){
     var ans = confirm("Are you sure you want to change the requestor status?");
     if(ans){
          window.location = "php_requestor/toPending.php?requestor_id=" + requestor_id; //displaying to url the selected user id
     }
}
function ToApproved(requestor_id){
     var ans = confirm("Are you sure you want to change the requestor status?");
     if(ans){
          window.location = "php_requestor/toApproved.php?requestor_id=" + requestor_id; //displaying to url the selected user id
     }
}
function ToCompleted(requestor_id){
     var ans = confirm("Are you sure you want to change the requestor status?");
     if(ans){
          window.location = "php_requestor/toCompleted.php?requestor_id=" + requestor_id; //displaying to url the selected user id
     }
}
</script>
     ...
     <div class="sidebar">
          ...
          <div class="sidebar-menu">
               <ul>
                    ...
                    <li>
                         <a href="requestors.php" class="active"><span class="las la-hands-helping"></span>
