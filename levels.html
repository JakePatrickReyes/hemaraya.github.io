...
function changeStock(hospital_id){
     var ans = confirm("Are you sure you want to change the hospital stock?");
     if(ans){
          window.location = "editHospital.php?hospital_id=" + hospital_id; //displaying to url the selected user id
     }
}
</script>
     ...
     <div class="sidebar">
          ...
          <div class="sidebar-menu">
               <ul>
                    ...
                    <li>
                         <a href="levels.php" class="active"><span class="las la-hospital-alt"></span>
