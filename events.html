...
function ToPending(event_id){
     var ans = confirm("Are you sure you want to change the event status?");
     if(ans){
          window.location = "php_event/toPending.php?event_id=" + event_id; //displaying to url the selected user id
     }
}
function ToApproved(event_id){
     var ans = confirm("Are you sure you want to change the event status?");
     if(ans){
          window.location = "php_event/toApproved.php?event_id=" + event_id; //displaying to url the selected user id
     }
}
function ToCompleted(event_id){
     var ans = confirm("Are you sure you want to change the event status?");
     if(ans){
          window.location = "php_event/toCompleted.php?event_id=" + event_id; //displaying to url the selected user id
     }
}
</script>
     ...
     <div class="sidebar">
          ...
          <div class="sidebar-menu">
               <ul>
                    ...
                    <li>
                         <a href="events.php" class="active"><span class="las la-calendar-times"></span>
