...
<head>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
     ...
     <script>
		...
		function ChangeStat(user_id){
			var ans = confirm("Are you sure you want to change the user status?");
			if(ans){
				window.location = "php_user/updateUserStatus.php?user_id=" + user_id; //displaying to url the selected user id
			}
		}
	</script>
